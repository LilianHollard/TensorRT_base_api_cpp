...
CFLAGS= -O2 -std=c++0x -I /usr/local/cuda-10.2/include/ -I /usr/local/include/opencv4/ -I /usr/src/tensorrt/samples/common/ -I /usr/include/aarch64-linux-gnu/


LDFLAGS= $(LDLIBS) -lm -lstdc++ $(CVLIBS) -lcuda -lcublas -lcurand -lcudart
